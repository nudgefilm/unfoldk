...
export function FlightStatusPanel({ flight }: Props) {
  ...
  return (
    <div className="shrink-0 flex flex-col p-3 font-mono text-white">
      <div className="text-[11px] uppercase tracking-wider text-[#cbd5e1] mb-0.5 hover:text-white transition-colors duration-150 cursor-default">Flight Status</div>

      {/* STATUS */}
      <div className="grid grid-cols-[110px_1fr] gap-1 py-0 mb-0.5 group cursor-default">
      ...
      <div className="border-t border-[#4a9eff]/15 my-0.5" />
