    ...
    <html lang="en">
      <body className="font-sans antialiased bg-background pt-[72px]">
        ...
        <Script
          ...
          strategy="afterInteractive"
          dangerouslySetInnerHTML={{
            __html: `window.$crisp=[];window.CRISP_WEBSITE_ID="7b8d0841-0a14-40b8-8501-87cfaaa21bbc";(function(){var d=document;var s=d.createElement("script");s.src="https://client.crisp.chat/l.js";s.async=1;d.getElementsByTagName("head")[0].appendChild(s);})();window.$crisp.push(["do","chat:hide"]);`,
          }}
        />
      </body>
    </html>
