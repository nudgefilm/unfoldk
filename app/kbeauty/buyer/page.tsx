    ...
    <section className="bg-white py-20 px-6">
      <div className="max-w-[960px] mx-auto">
        <div className="grid md:grid-cols-3 gap-6">
          ...
          {/* Stat 3 */}
          <div className="bg-[#F8F7F5] rounded-xl p-8 text-center">
            <div className="font-serif text-[28px] text-[#C8A882] mb-2">3304 &middot; 3305 &middot; 3307</div>
            <div className="text-[13px] font-medium text-[#6B6B6B] mb-1">
              HS Codes Covered
            </div>
            <div className="text-xs text-[#6B6B6B]">
...
function BuyerBenefitsSection() {
  const benefits = [
    ...
    },
    {
      ...
      desc: "Data-backed reports on US import trends for HS codes 3304, 3305, and 3307.",
    },
    {
      badge: "Direct",
      badgeStyle: "bg-[#1A3A5C]/10 text-[#1A3A5C]",
      title: "Direct Match",
      desc: "Connect directly with suppliers after identity verification. No middlemen.",
    },
  ]
  ...
  const steps = [
    {
      number: "1",
      title: "Register",
      sub: "Submit your business info",
      desc: "EIN · VAT · Website required",
    },
    {
      number: "2",
      title: "Get Approved",
      sub: "Admin review within 1 business day",
      desc: "Confirmation via email",
    },
    {
      number: "3",
      title: "Browse & Match",
      sub: "Access verified Korean suppliers",
      desc: "Request matches directly",
    },
  ]
