        ...
        <Sheet>
          ...
          <SheetContent side="bottom" className="bg-white border-t border-[#E8E2DA]">
            <nav className="flex flex-col gap-4 mt-6">
              <a href="#suppliers" className="text-[#6B6B6B] hover:text-[#0F0F0F] py-2">
                For Suppliers
              </a>
              <a href="#buyers" className="text-[#6B6B6B] hover:text-[#0F0F0F] py-2">
                For Buyers
              </a>
              <a href="#how-it-works" className="text-[#6B6B6B] hover:text-[#0F0F0F] py-2">
                How It Works
              </a>
              <a href="#data-sources" className="text-[#6B6B6B] hover:text-[#0F0F0F] py-2">
                Data Sources
              </a>
        ...
        <div className="grid lg:grid-cols-[55%_45%] gap-12 items-center">
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-4">
              <button className="bg-[#1A3A5C] text-white font-semibold px-7 py-3.5 rounded-md hover:bg-[#153249] transition-colors inline-flex items-center justify-center gap-2">
                공급사 파트너 신청
                <span className="text-lg">&#8594;</span>
              </button>
              <button className="border-[1.5px] border-[#1A3A5C] text-[#1A3A5C] font-semibold px-7 py-3.5 rounded-md hover:bg-[#1A3A5C]/5 transition-colors inline-flex items-center justify-center gap-2">
                Get Buyer Access
                <span className="text-lg">&#8594;</span>
              </button>
            </div>
      ...
      <div className="max-w-[960px] mx-auto">
        <div className="grid md:grid-cols-3 gap-8 md:gap-0">
          ...
          <div className="text-center md:pl-8">
            ...
            <div className="text-[13px] text-white/40">
              Skincare &middot; Haircare &middot; Fragrance
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-[880px] mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6" id="buyers">
          ...
          <div className="bg-white border border-[#E8E2DA] rounded-xl p-8 shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
            ...
            <button className="w-full bg-[#1A3A5C] text-white font-semibold py-3.5 rounded-md hover:bg-[#153249] transition-colors inline-flex items-center justify-center gap-2">
              공급사 파트너 신청
              <span className="text-lg">&#8594;</span>
            </button>
          </div>
          ...
          <div className="bg-white border border-[#E8E2DA] rounded-xl p-8 shadow-[0_2px_8px_rgba(0,0,0,0.06)]">
            ...
            <button className="w-full border-[1.5px] border-[#C8A882] text-[#8B6F47] font-semibold py-3.5 rounded-md hover:bg-[#C8A882]/10 transition-colors inline-flex items-center justify-center gap-2">
              Get Buyer Access
              <span className="text-lg">&#8594;</span>
            </button>
          </div>
  ...
  const supplierSteps = [
    {
      ...
      title: "사업자 인증",
      desc1: "국세청 API 자동 검증",
      desc2: "빠르고 정확한 국내 사업자 확인",
    },
    {
      number: "2",
      title: "제품 등록",
      desc1: "인증 배지 포함 상세 등록",
      desc2: "MOQ·가격·수출 조건 포함",
    },
    {
      number: "3",
      title: "바이어 매칭 요청",
      desc1: "타깃 국가·카테고리 설정",
      desc2: "검증된 바이어에게 직접 요청",
    },
    {
      number: "4",
      title: "컨택 정보 공개",
  ...
  const buyerSteps = [
    {
      ...
      desc1: "EIN · VAT · Website required",
      desc2: "Business accounts only",
    },
    {
      number: "2",
      title: "Get Approved",
      desc1: "Admin review within 1 business day",
      desc2: "Confirmation via email",
    },
    {
      number: "3",
      title: "Browse Suppliers",
      desc1: "Filter by FDA · Certification · MOQ",
      desc2: "Access verified Korean manufacturers",
    },
    {
      number: "4",
      title: "Request a Match",
      desc1: "Submit business documents",
      desc2: "Contact info released after approval",
    },
  ]
