  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-sm text-[#6B6B6B] text-center mb-6">등록된 이메일과 비밀번호를 입력하세요.</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-[#0F0F0F] mb-2">이메일</label>
          ...
          <div>
            <label className="block text-sm font-medium text-[#0F0F0F] mb-2">비밀번호</label>
        ...
        <div className="mt-5 text-center text-sm text-[#6B6B6B]">
          아직 계정이 없으신가요?{" "}
          <Link href="/kbeauty/supplier" className="text-[#1A3A5C] font-medium hover:underline">공급사 파트너 신청</Link>
        </div>
      </div>
    </div>
  )
